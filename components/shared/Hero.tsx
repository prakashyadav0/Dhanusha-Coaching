  ...
  return (
    <>
      ...
      <Head>
        ...
        <meta property="og:url" content="https://dhanushacoaching.com.np" />
        ...
        />
        <link rel="canonical" href="https://dhanushacoaching.com.np" />
      </Head>
      ...
      <section className="relative overflow-hidden min-h-[600px] flex items-center ">
        ...
        <div className="absolute inset-0">
          ...
          <div className="absolute inset-0 bg-gradient-to-r from-red-800/60 via-red-700/50 to-red-800/60" />
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-4 py-24 text-center text-white">
          {/* Badge */}
          <div className="inline-block bg-red-400/10 backdrop-blur-sm border border-red-400/30 rounded-full px-4 py-1.5 mb-6">
