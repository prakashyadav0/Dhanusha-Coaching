  ...
  return (
    <div>
      ...
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          <h1 className="text-xl sm:text-2xl font-bold text-gray-900">Syllabus</h1>
          <p className="text-sm text-gray-500">Course syllabi for everyone &amp; your enrolled courses</p>
        </div>
      </div>
      ...
      {links.length === 0 ? (
        <div className="text-center py-20 text-gray-400">
          ...
          <p className="font-medium text-gray-500">No syllabus available right now.</p>
          <p className="text-sm mt-1">
            Enroll in a course to unlock its syllabus, or check back soon!
          </p>
        </div>
      ) : (
            ...
            >
              <div className="flex flex-col sm:flex-row sm:items-center gap-4">
                ...
                <a
                  ...
                  className="shrink-0 flex items-center justify-center gap-2 bg-blue-500 hover:bg-blue-600 text-white text-sm font-semibold px-5 py-3 rounded-xl transition w-full sm:w-auto"
                >
                  📄 View Syllabus
                </a>
              </div>
