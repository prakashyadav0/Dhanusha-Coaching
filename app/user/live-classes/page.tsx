          ...
          {links.map(link => (
            ...
            >
              <div className="flex flex-col sm:flex-row sm:items-center gap-4">
                {/* Icon */}
                <div className="shrink-0 w-12 h-12 rounded-xl bg-red-50 flex items-center justify-center text-2xl">
                  🔴
                </div>
                ...
                <a
                  ...
                  className="shrink-0 flex items-center justify-center gap-2 bg-red-600 hover:bg-red-700 text-white text-sm font-semibold px-5 py-3 rounded-xl transition w-full sm:w-auto"
                >
                  🔴 Join Live
                </a>
              </div>
